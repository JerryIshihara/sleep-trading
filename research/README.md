...
11. **[dashboards/survey.md](./dashboards/survey.md)** — Real-world trading dashboards: market data visualization (TradingView, Plotly Dash), portfolio & position tracking (Freqtrade, Hummingbot, Base Trading), strategy performance (Grafana+Prometheus, QuantConnect, AI-Predictor), system health & ops (Cryptohopper, community Grafana setups). Design patterns, tech stacks, and ASCII reference layout for a unified sleep-trading dashboard.
